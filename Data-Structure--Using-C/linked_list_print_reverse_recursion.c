...
//hard coded approach
    ...
    printf("Reverse printing of Linked List using RECURSION\n(NOTE: we are not swapping data or rearranging nodes, we're only printing data in reverse order):- \n\n");
    Disp(head);
...
void Disp(NODE head) {
    ...
    printf("%d -> ",head->iData);       //printing after recursive call leads reverse order printing
}
